...
const Summary: React.FC<SummaryProps> = ({ parsedSummary }) => {
                        ...
                        <Card className="rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-300">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {expandedTests.includes(test.name) && (
                                        <>
                                            {test.importance && (
                                                <div>
                                                    <h4 className="font-semibold text-sm text-gray-500 mb-1">Why This Test Matters</h4>
                                                    <p className="text-gray-700">{test.importance}</p>
                                                </div>
                                            )}
                                            {test.tip && (
                                                <div>
                                                    <h4 className="font-semibold text-sm text-gray-500 mb-1">Tiny Tip</h4>
                            ...
                            <CardFooter className="flex flex-col items-start gap-2 pt-0">
                                ...
                                {test.result && test.result !== "No reading available" && test.result !== "Not specified" && (
                                    ...
                                    >
                                        {expandedTests.includes(test.name) ? 'Show Less' : 'Learn More'}
