...
import { FUNNY_SUMMARY_SYSTEM_PROMPT2, FUNNY_SUMMARY_SYSTEM_PROMPT_HINDI, GENZ_SUMMARY_PROMPT, } from "./promt";
...
export const generatePdfSummaryFromGroqGenz = async (pdfText: string) => {
    try {
        const completion = await groq.chat.completions.create({
            model: "gemma2-9b-it", // or "llama2-70b-4096"
            messages: [
